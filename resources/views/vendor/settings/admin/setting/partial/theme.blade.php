                      ...
                      <fieldset>
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-4"> 
                           ...
                           -> value(public_path('themes/admin/assets/img/logo/logo.png'))!!}
                          </div>
                         <div class="col-md-4"> 
                           ...
                           -> value(public_path('themes/admin/assets/img/logo/logo-white.png'))!!}
                         </div>
                        </div>
                      </fieldset>
                      ...
                      <fieldset>
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-4"> 
                           ...
                           -> value(public_path('themes/user/assets/img/logo/logo.png'))!!}
                          </div>
                         <div class="col-md-4"> 
                           ...
                           -> value(public_path('themes/user/assets/img/logo/logo-white.png'))!!}
                         </div>
                        </div>
                      </fieldset>
                      ...
                      <fieldset>
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-4"> 
                           ...
                           -> value(public_path('themes/public/assets/img/logo/logo.png'))!!}
                          </div>
                         <div class="col-md-4"> 
                           ...
                           -> value(public_path('themes/public/assets/img/logo/logo-white.png'))!!}
                         </div>
                        </div>
                      </fieldset>
